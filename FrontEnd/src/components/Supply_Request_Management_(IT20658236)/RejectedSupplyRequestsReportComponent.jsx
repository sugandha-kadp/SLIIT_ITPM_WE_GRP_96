...
class RejectedSupplyRequestsReportComponent extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount(){
        SupplyRequestService.getRejectedSupplyRequest().then((res) => {
            this.setState({ supplyRequests: res.data});
            console.log(this.state.supplyRequests);
        });
    }
        ...
        <div>
          <HeaderComponent></HeaderComponent>
            <div ref ={el=>(this.componentRef=el)}>
                <div id='repG'>   
                    <h2 className="text-center mt-4 ">Rejected Supply Request Report</h2>
                    <br></br>
                                        ...
                                        <table className = "table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className='text-center'> Rejected Date & Time</th>
                                            ...
                                            <tbody>
                                                {
                                                    this.state.supplyRequests.map(
                                                        ...
                                                        <tr key = {supplyRequest.requestID}>
                                                            ...
                                                            <td className='text-center'> {supplyRequest.dateTime}</td>
...
export default RejectedSupplyRequestsReportComponent;